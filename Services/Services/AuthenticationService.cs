...
public class AuthenticationService : IAuthenticationService
{
    ...
    public async Task<Response<TokenDto>> CreateTokenByRefreshTokenAsync(string refreshToken)
    {
        ...
        {
            return Response<TokenDto>.Fail("Refresh token is not found", 400, true);
        }
        ...
        if (user == null)
        {
            return Response<TokenDto>.Fail("UserId is not found", 400, true);
        }
    ...
    public async Task<Response<NoDataDto>> RevokeRefreshTokenAsync(string refreshToken)
    {
        ...
        if (existRefreshToken == null)
        {
            return Response<NoDataDto>.Fail("Refresh token is not found", 400, true);
        }
